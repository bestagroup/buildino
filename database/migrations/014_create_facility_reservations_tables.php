    ...
    public function up(): void
    {
        ...
        */
        ...
        Schema::create('facility_reservations', function (Blueprint $table) {
            ...
            $table->index(['building_facility_id', 'reservation_date'], 'facility_reservation_date_idx');

            $table->index(['unit_id', 'status'], 'unit_reservation_status_idx');
        });
        /*
        |--------------------------------------------------------------------------
        ...
        */
        Schema::create('reservation_payments', function (Blueprint $table) {
            ...
            $table->foreignId('facility_reservation_id')->constrained()->cascadeOnDelete();
        ...
        */
        Schema::create('reservation_notifications', function (Blueprint $table) {
            ...
            $table->enum('type',['created', 'approved', 'rejected', 'cancelled', 'reminder', 'changed']);
